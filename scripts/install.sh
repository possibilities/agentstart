...
# implicit approval.
fx_integration_sha=4cd9c45a40a4b87c26e1211808d99aec387b4e10
...
Command-line tools:
  ...
  ~/code/fxnk/scripts/install.sh --install --sha 4cd9c45a40a4b87c26e1211808d99aec387b4e10  # exact ship-gate-approved Fx Integration consumer pin
