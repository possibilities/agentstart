...
# implicit approval.
fx_integration_sha=409055c824e499d84d5003a80375c69bfe248bfe
...
Command-line tools:
  ...
  ~/code/fxnk/scripts/install.sh --install --sha 409055c824e499d84d5003a80375c69bfe248bfe  # exact ship-gate-approved Fx Integration consumer pin
