...
# implicit approval.
fx_integration_sha=c1ef62613bf26b4a604eae8d0674c42d59906b04
...
Command-line tools:
  ...
  ~/code/fxnk/scripts/install.sh --install --sha c1ef62613bf26b4a604eae8d0674c42d59906b04  # exact ship-gate-approved Fx Integration consumer pin
