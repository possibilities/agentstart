...
# implicit approval.
fx_integration_sha=beadc01a82891ef22bfa6cd3bc88f12edcec9176
...
Command-line tools:
  ...
  ~/code/fxnk/scripts/install.sh --install --sha beadc01a82891ef22bfa6cd3bc88f12edcec9176  # exact ship-gate-approved Fx Integration consumer pin
