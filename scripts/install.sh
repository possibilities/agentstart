...
# implicit approval.
fx_integration_sha=ca773013b48be68451ed363f168f0a3251e50db2
...
Command-line tools:
  ...
  ~/code/fxnk/scripts/install.sh --install --sha ca773013b48be68451ed363f168f0a3251e50db2  # exact ship-gate-approved Fx Integration consumer pin
