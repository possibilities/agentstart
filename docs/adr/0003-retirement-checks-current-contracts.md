...
Pi's official CLI was later restored as a bare toolchain install. That does
not reverse this retirement: AgentStart still installs no Pi MCP, skills,
extensions, guidance, Herdr integration, or AgentLaunch support.
