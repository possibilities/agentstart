...
Supersedes [ADR 0001](0001-keep-core-skills-out-of-compatibility-roots.md).
Historical rationale restored September 8, 2026. The resource-set decision
remains in effect; references to launch tooling below describe the choice
at the time. The repository README documents the current launch contract.
