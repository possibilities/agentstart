...
Historical record restored September 8, 2026. The original decision follows;
the current resource contract is in [ADR 0002](0002-render-one-private-resource-set.md)
